            ...
            (updateError) => {
              ...
              db.get(
                ...
                (_countError, row: { count: number }) => {
                  ...
                  db.run(
                    `INSERT INTO "Person" ("firstName", "lastName", "arrivalDate", "isWorking", "age") VALUES
                      ('Urist', 'McDwarf', '2026-09-15', 1, 100),
                      ('Mafol', 'Craftsdwarf', '2026-09-14', 1, 98),
                      ('Domas', 'Stoneworker', '2026-09-13', 0, 99)`,
                    (seedError) => {
                      db.close();
